{{-- filepath: d:\code_personal\edupoint-lms\resources\views\livewire\admin\course\create.blade.php --}}
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md">
            ...
            <div class="p-6 border-b border-gray-200 dark:border-gray-700">
                <div class="flex items-center justify-between">
                    <h2 class="text-2xl font-bold text-gray-800 dark:text-gray-100">Create New Course</h2>
            ...
            <form wire:submit="store" class="p-6 space-y-6">
                ...
                <div>
                    ...
                    <input type="text" id="category" wire:model="category"
                        class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 placeholder-gray-500 dark:placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent @error('category') border-red-500 @enderror"
